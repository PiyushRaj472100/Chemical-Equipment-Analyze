...
A comprehensive system for analyzing and managing chemical equipment data with both web and desktop interfaces. This application provides powerful tools for uploading CSV files containing equipment data, visualizing analytics, generating reports, and tracking equipment maintenance schedules.
...
- **Desktop Application**: PyQt5-based desktop client
